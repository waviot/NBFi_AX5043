...
//    case UL_DBPSK_50_PROT_E:
        ...
        //ax5043_spi_write(AX5043_PINFUNCSYSCLK          , 0x04);
        //ax5043_spi_write(AX5043_PINFUNCDCLK            , 0x01);
        //ax5043_spi_write(AX5043_PINFUNCDATA            , 0x01);
        //ax5043_spi_write(AX5043_PINFUNCANTSEL          , 0x82);
        ...
        ax5043_spi_write(AX5043_MODCFGA                , 0x06);
        ax5043_spi_write(AX5043_TXRATE2                , 0x00);
        ax5043_spi_write(AX5043_TXRATE1                , 0x00);
        ax5043_spi_write(AX5043_TXRATE0                , 0x81);
        ax5043_spi_write(AX5043_TXPWRCOEFFB1           , 0x0F);
        ax5043_spi_write(AX5043_TXPWRCOEFFB0           , 0xFF);
...
//    case UL_DBPSK_3200_PROT_E:
        ...
        ax5043_spi_write(AX5043_FSKDEV1                , 0x00);
        ax5043_spi_write(AX5043_FSKDEV0                , 0x00);
        ax5043_spi_write(AX5043_MODCFGA                , 0x05);
        ax5043_spi_write(AX5043_TXRATE2                , 0x00);
    ...
    case UL_PSK_200:
        ...
        ax5043_spi_write(AX5043_TXRATE1                , 0x00);
        ax5043_spi_write(AX5043_TXRATE0                , 0x81);
        ax5043_spi_write(AX5043_TXPWRCOEFFB1           , 0x02);
        ax5043_spi_write(AX5043_TXPWRCOEFFB0           , 0x07);
        ax5043_spi_write(AX5043_PLLRNGCLK              , 0x04);
        ax5043_spi_write(AX5043_BBTUNE                 , 0x0F);
        ax5043_spi_write(AX5043_BBOFFSCAP              , 0x77);
    ...
    case UL_PSK_FASTDL:
        ...
        ax5043_spi_write(AX5043_TXPWRCOEFFB1           , 0x03);
        ax5043_spi_write(AX5043_TXPWRCOEFFB0           , 0x98);
        ax5043_spi_write(AX5043_PLLRNGCLK              , 0x04);
        ax5043_spi_write(AX5043_BBTUNE                 , 0x0F);
        ax5043_spi_write(AX5043_BBOFFSCAP              , 0x77);
        ax5043_spi_write(AX5043_PKTADDRCFG             , 0x81);
